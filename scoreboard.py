...
class Scoreboard():
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        # Configurações de fonte para as informações de pontuação v
    ...
    def prep_pilot(self):
        ...
        for ship_number in range(self.stats.ships_left):
            pilot = Pilot(self.ai_settings, self.screen)
            pilot.rect.x = 10 + ship_number * pilot.rect.width
            pilot.rect.y = 10
